...
public class Ans_1 {
	...
	public static void main(String[] args) throws Exception {
		...
		Thread.sleep(1500);
		driver.findElement(By.xpath("//input[contains(@name,'firstname')]")).sendKeys("babu");
		driver.findElement(By.xpath("//input[contains(@name,'lastname')]")).sendKeys("ram");
		driver.findElement(By.xpath("//input[contains(@name,'reg_email__')]")).sendKeys("testmiller03@gmail.com");
		driver.findElement(By.xpath("//input[contains(@name,'reg_email_confirmation__')]"))
				.sendKeys("testmiller03@gmail.com");
		driver.findElement(By.xpath("//input[contains(@name,'reg_passwd__')]")).sendKeys("Testuser@123");
